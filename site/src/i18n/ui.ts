...
export const ui = {
  es: {
    ...
    // ── Autorización de cargo a TDC (cliente, 2026-09-14) ────────────────────
    // 🔴 Este formulario NO pide número de tarjeta ni CVV, y no es un olvido:
    // ver la cabecera de `src/booking/autorizacion.ts`. Lleva los 18 campos
    // del formulario del sitio vigente que SÍ se pueden pedir, y los cuatro
    // dígitos finales en lugar del PAN completo.
    'tdc.titulo': 'Formulario de autorización de reservación con cargo a TDC',
    // El <title> de la pestaña, aparte y CORTO: con la etiqueta larga del
    // cliente más « | Azucar Hotel Tulum» pasaba de 70 caracteres y
    // html-validate falla el build. En el pie y en el <h1> va la larga.
    'tdc.tituloCorto': 'Autorización de cargo a TDC',
    'tdc.meta': 'Autoriza por escrito el cargo a tu tarjeta por una reserva en Azucar Hotel Tulum. No pedimos el número completo de la tarjeta ni el código de seguridad.',
    'tdc.entrada': 'Con este formulario el titular de una tarjeta autoriza por escrito el cargo de una reserva. Es el documento que el hotel necesita cuando quien paga no es quien se hospeda.',
    'tdc.comoSeCobra': '🔒 No te pedimos el número completo de tu tarjeta ni el código de seguridad, y no es un descuido: enviarlos por correo es inseguro y está prohibido por las reglas de las marcas de tarjetas. Sólo los cuatro últimos dígitos, para que el hotel identifique cuál es. El cargo lo hace después el hotel, contigo al teléfono o con un enlace de pago seguro.',
    'tdc.grupoReserva': 'La reserva',
    'tdc.grupoTitular': 'El titular de la tarjeta',
    'tdc.grupoDomicilio': 'Domicilio de facturación',
    'tdc.grupoAutorizacion': 'La autorización',
    'tdc.fecha': 'Fecha',
    'tdc.llegada': 'Llegada',
    'tdc.salida': 'Salida',
    'tdc.habitaciones': 'Tipo de alojamiento',
    'tdc.habitacionesPista': 'El tipo reservado. Si son varias unidades, dilo en el correo al enviarlo.',
    'tdc.huespedes': 'Número de huéspedes',
    'tdc.huespedPrincipal': 'Huésped principal',
    'tdc.titular': 'Nombre del titular, como aparece en la tarjeta',
    'tdc.titularCorto': 'Titular de la tarjeta',
    'tdc.telefono': 'Teléfono',
    'tdc.tipoTarjeta': 'Tipo de tarjeta',
    'tdc.elige': 'Elige una',
    'tdc.otra': 'Otra',
    'tdc.ultimos4': 'Últimos 4 dígitos',
    'tdc.ultimos4Pista': 'Sólo los cuatro últimos. Nunca escribas aquí el número completo.',
    'tdc.calle': 'Calle',
    'tdc.numeroExterior': 'Número exterior',
    'tdc.numeroInterior': 'Número interior',
    'tdc.codigoPostal': 'Código postal',
    'tdc.colonia': 'Colonia',
    'tdc.ciudad': 'Ciudad',
    'tdc.pais': 'País',
    'tdc.total': 'Total autorizado',
    'tdc.totalPista': 'El importe exacto que autorizas, con su moneda.',
    'tdc.declaracion': 'Autorizo a Azucar Hotel Tulum a realizar el cargo indicado en este formulario a la tarjeta de la que soy titular.',
    'tdc.acepto': 'Acepto el cargo indicado en este formulario',
    'tdc.asunto': 'Autorización de cargo a TDC',
    'tdc.domicilio': 'Domicilio de facturación',
    'tdc.faltan': 'Faltan datos obligatorios:',
    'tdc.ultimos4Mal': 'Los últimos dígitos tienen que ser exactamente cuatro números.',
    'tdc.aceptaFalta': 'Hay que aceptar el cargo para poder enviar la autorización.',
  ...
  en: {
    ...
    // del formulario del sitio vigente que SÍ se pueden pedir, y los cuatro
    // dígitos finales en lugar del PAN completo.
    'tdc.titulo': 'Credit card charge authorization form',
    'tdc.tituloCorto': 'Card charge authorization',
    'tdc.meta': 'Authorize a charge to your card for a booking at Azucar Hotel Tulum in writing. We never ask for your full card number or security code.',
    'tdc.entrada': 'With this form the cardholder authorizes a booking charge in writing. It is the document the hotel needs when the person paying is not the person staying.',
    'tdc.comoSeCobra': '🔒 We do not ask for your full card number or your security code, and that is deliberate: sending them by email is unsafe and prohibited by the card network rules. Only the last four digits, so the hotel knows which card it is. The hotel then takes the payment with you on the phone or through a secure payment link.',
    'tdc.grupoReserva': 'The booking',
    'tdc.grupoTitular': 'The cardholder',
    'tdc.grupoDomicilio': 'Billing address',
    'tdc.grupoAutorizacion': 'The authorization',
    'tdc.fecha': 'Date',
    'tdc.llegada': 'Check-in',
    'tdc.salida': 'Check-out',
    'tdc.habitaciones': 'Accommodation type',
    'tdc.habitacionesPista': 'The type booked. If it is more than one unit, say so in the email when you send it.',
    'tdc.huespedes': 'Number of guests',
    'tdc.huespedPrincipal': 'Main guest',
    'tdc.titular': 'Cardholder name, as it appears on the card',
    'tdc.titularCorto': 'Cardholder',
    'tdc.telefono': 'Phone',
    'tdc.tipoTarjeta': 'Card type',
    'tdc.elige': 'Choose one',
    'tdc.otra': 'Other',
    'tdc.ultimos4': 'Last 4 digits',
    'tdc.ultimos4Pista': 'The last four only. Never write the full number here.',
    'tdc.calle': 'Street',
    'tdc.numeroExterior': 'Number',
    'tdc.numeroInterior': 'Unit',
    'tdc.codigoPostal': 'Postal code',
    'tdc.colonia': 'District',
    'tdc.ciudad': 'City',
    'tdc.pais': 'Country',
    'tdc.total': 'Authorized total',
    'tdc.totalPista': 'The exact amount you authorize, with its currency.',
    'tdc.declaracion': 'I authorize Azucar Hotel Tulum to charge the amount stated in this form to the card of which I am the holder.',
    'tdc.acepto': 'I accept the charge stated in this form',
    'tdc.asunto': 'Card charge authorization',
    'tdc.domicilio': 'Billing address',
    'tdc.faltan': 'Required fields are missing:',
    'tdc.ultimos4Mal': 'The last digits must be exactly four numbers.',
    'tdc.aceptaFalta': 'You must accept the charge before sending the authorization.',
...
export const segmentos = {
  ...
  'autorizacion-tdc': { es: 'autorizacion-tdc', en: 'card-authorization' },
} as const;
